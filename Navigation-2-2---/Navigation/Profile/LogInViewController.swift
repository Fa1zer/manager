...
class LogInViewController: UIViewController {
    ...
    @objc fileprivate func tapButton() {
        ...
        let viewController = ProfileViewController(userService: CurrentUserService(),
                                                   name: usersEmailOrPhone.text!)
        
        #else
        
        let viewController = ProfileViewController(userService: TestUserService(),
                                                   name: usersEmailOrPhone.text!)
